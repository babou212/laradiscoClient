...
export const group_approve_staged_commit: (a: number, b: number) => [number, number];
...
export const group_create_new: (a: number, b: number, c: number, d: number) => [number, number, number];
export const group_delete: (a: number, b: number) => [number, number];
export const group_discard_staged_commit: (a: number) => [number, number];
...
export const group_has_pending_staged_commit: (a: number) => number;
...
export const identity_key_package: (a: number, b: number) => [number, number, number];
...
export const keypackage_credential_identity: (a: number) => [number, number];
...
export const processedmessage_staged_commit_json: (a: number) => [number, number];
