...
export class Group {
     ...
     */
    approve_staged_commit(provider: Provider): void;
...
export class ProcessedMessage {
     ...
     * Shape: {"added_identities_b64":[..], "removed_indices":[..], "updated_identities_b64":[..]}.
     ...
     */
    readonly staged_commit_json: string | undefined;
}
...
export interface InitOutput {
    ...
    readonly group_approve_staged_commit: (a: number, b: number) => [number, number];
    ...
    readonly group_discard_staged_commit: (a: number) => [number, number];
    ...
    readonly group_has_pending_staged_commit: (a: number) => number;
    ...
    readonly keypackage_credential_identity: (a: number) => [number, number];
    ...
    readonly processedmessage_staged_commit_json: (a: number) => [number, number];
